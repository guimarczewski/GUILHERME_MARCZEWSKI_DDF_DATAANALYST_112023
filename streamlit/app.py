...
def main():
    ...
    product1_data['features'] = product1_data['features'].replace('{', ' ').replace('}', ' ').replace('"', ' ').replace(':', ' ')
    product2_data['features'] = product2_data['features'].replace('{', ' ').replace('}', ' ').replace('"', ' ').replace(':', ' ')
